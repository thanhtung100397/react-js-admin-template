    ...
    <div className="login-page wh-full" style={pageStyle}>
      <AppContainer className="wh-full">
        <AppCard>
          ...
          <AppForm>
            <AppForm.Item label="Hello world" validateStatus="success" validateMessage={`This is success ${value}!`} validateRules={[ValidationRule.REQUIRED]}>
              <AppInput/>
            </AppForm.Item>
            <AppForm.Item label="Hello world 3" labelCol={{width: 20}} showSuccessValidateStatus={true} validateStatus="warning" validateMessage="This is warning!" validateRules={[ValidationRule.REQUIRED]}>
              <AppInput/>
            </AppForm.Item>
