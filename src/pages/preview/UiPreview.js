  ...
  },
  {
    ...
    content: (
      <Row gutter={ROW_GUTTER} vStretch={true}>
        ...
        <Col xs={24} sm={24} md={12} lg={12} xl={12} xxl={8}>
          {
            contentCard('Force wh-size/square options', 'Force image w:h size ratio',
              <AppSpace size={ITEM_SPACE}>
                <Row vStretch={true}>
                  <Col xs={24} sm={24} md={24} lg={24} xl={24} xxl={24}>
                    <Text>Square Ratio</Text>
                    <AppImage className="wh-full" src={APP_IMAGE_URL}
                              enablePreview={true} square={true}/>
                  </Col>
                </Row>
                <Row vStretch={true} gutter={ROW_GUTTER}>
                  <Col xs={24} sm={24} md={24} lg={6} xl={6} xxl={6}>
                    <Text>1:2 Ratio</Text>
                    <AppImage src={APP_IMAGE_URL} enablePreview={true} whRatio={1/2}/>
                  </Col>
                  <Col xs={24} sm={24} md={24} lg={18} xl={18} xxl={18}>
                    <Text>16:9 Ratio</Text>
                    <AppImage src={APP_IMAGE_URL} enablePreview={true} whRatio={16/9}/>
                  </Col>
                </Row>
              </AppSpace>
            )
